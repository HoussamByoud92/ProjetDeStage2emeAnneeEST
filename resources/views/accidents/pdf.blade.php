...
<div>
  ...
  <div class="d-flex text-dark m-5 justify-content-between">
          ...
          <div class="card-header  bg-gradient-danger text-light text-center text-bold">
            <h5>Etude et analyse de l’accident</h5>
          </div>
...
<div class="card shadow mb-4 bg-light text-dark border-bottom-success">
...
<div class="container form-group row">
  ...
  <div class="w-100 col-xs-3 d-inline-block p-1">
    <p>Lieu précis de l`événement : 
    {{$accident->LieuEve}}</p>
  </div>
  <div class="w-100 col-xs-3 d-inline-block p-1">
    <p>Heure de l’événement  : 
    {{$accident->heure}}</p>
  </div>
  <div class="col-xs-4 w-50 d-inline-block p-1">
    <p>Signalé par :  
    {{$accident->signalant}}</p>
  </div>
    <div class="col-xs-4 w-50 d-inline-block p-1">
  ...
  <div class="col-xs-4 w-50 d-inline-block p-1">
    <p>Nature des dommages :  
    {{$accident->NatureDomm}}</p>
  </div>
  <div class="col-xs-2 w-50 d-inline-block p-1">
    <label for="ex1">Siège des lésions/dommages : : 
    {{$accident->SiegeDomme}}</p>
  </div>
  <div class="col-xs-3 w-100 d-inline-block p-1">
    <p>Description des dommages : </br>
    {{$accident->Description}}</p>
  </div>
  <div class="col-xs-4 w-100 d-inline-block p-1">
    <p>Identifiant victime(s) , matricule, CIN ou autres : 
    {{$accident->IDVictime}}</p>
  </div>
  <div class="col-xs-4 w-50 d-inline-block p-1">
    <p>Date de naissance : 
    {{$accident->DateNaiss}}</p>
  </div>
  <div class="col-xs-2 w-50 d-inline-block p-1">
    <label for="ex1">Date d’embauche : 
    {{$accident->DateEmb}}</p>
  </div>
  <div class="col-xs-4 w-50 d-inline-block p-1">
    <p>Matricule : 
    {{$accident->Matricule}}</p>
  </div>
  <div class="col-xs-2 w-50 d-inline-block p-1">
    <label for="ex1">Fonction : 
    {{$accident->Fonction}}</p>
  </div>
  ...
  <div class="col-xs-3 w-100 d-inline-block p-1">
    <p>Description du l’accident : </br>
    {{$accident->DescAcci}}</p>
  </div>
  <div class="col-xs-4 w-100 d-inline-block p-1">
    <p>Risques : </br>
  ...
  <div class="col-xs-4 w-100 d-inline-block p-1">
    <p>Chronologie du fait accidentel : </br>
    {{$accident->Chronologie}}</p>
  </div>
  ...
  <div class="col-xs-3 w-100 d-inline-block p-1">
    <p>Actions recommendées : </br> 
    {{$accident->ActionsRec}}</p>
  </div>
</div>
</div>
</div>
