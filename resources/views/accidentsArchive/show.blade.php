...
<div class="container form-group row">
  ...
  <div class="col-xs-2 w-100 d-inline-block p-2">
    ...
    <input disabled value="{{$accidentsArchive->DateArchivage}}" class="form-control border-primary border-2 border-primary" id="DateArchivage" name="DateArchivage" type="date" placeholder="Date d`archivage">
  ...
  <div class="col-xs-3 w-100 d-inline-block p-1">
    ...
    <embed src="{{asset('pdf/'.$accidentsArchive->AcciArch)}}" width="1080" height="800">
