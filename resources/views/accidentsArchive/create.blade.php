...
<form action="{{route('accidentsArchive.store')}}" enctype="multipart/form-data" method="post" class="container form-group row">
    @csrf
  ...
  <div class="col-xs-3 w-100 d-inline-block p-1">
    ...
    <input enctype="multipart/form-data" class="form-control border-primary border-2" type="file" name="AcciArch" id="AcciArch" accept=".pdf">
        @error('AcciArch')
