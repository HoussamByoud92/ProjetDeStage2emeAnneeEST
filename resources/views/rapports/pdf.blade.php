...
<head>
    ...
    <title>ER | {{Route::currentRouteName();}}</title>
...
<div>
  ...
  <div class="d-flex text-dark m-5 justify-content-between">
          <div>
            <p>RADEES</p>
            <p>DIVISION ELECTRICITE</p>
            <p>Service Exploitation Electricité</p>
            <p>Bureau Centrale de Conduite Réseau</p>

          </div>
          <div class="justify-content-ends">
            <img src="/images/logo.png"  width="140" >
          </div>
  </div>


          <div class="card-header  bg-gradient-danger text-light text-center text-bold">
            <h5>Fiche de Reporting Journalier</h5>
          </div>
...
<div class="card shadow mb-4 bg-light border-bottom-success">

<div class="card-header py-3 bg-gradient-success">
  <h6 class="m-0 font-weight-bold text-light">Rapport relatif au {{$rapport->Date}}</h6>
</div>
<div class="d-flex justify-content-center m-2">
<div class="container form-group row text-dark">
    
  <div class="col-xs-2 w-100 d-inline-block p-2 text-dark">
    <p>Date du rapport : 
    {{$rapport->Date}}</p> 
  </div>
 ...
 <h5 class="navbar navbar-dark py-0 bg-gradient-danger navbar-expand-lg py-md-0 w-100 p-2 text-light">
  ...
  <div class="col-xs-3 w-25 d-inline-block p-1">
    <p>Coupures fortuites : 
    {{$rapport->CoupFort}}</p> 
  </div>
  <div class="col-xs-4 w-25 d-inline-block p-1">
    <p>Coupures programmées : 
    {{$rapport->CoupProg}}</p> 
  </div>
  <div class="col-xs-4 w-25 d-inline-block p-1">
    <p>Durée des Coupures fortuites : 
    {{$rapport->DureeCF}}</p> 
  </div>

    <div class="col-xs-2 w-25 d-inline-block p-1">
    <p>Durée des Coupures prog : 
    {{$rapport->DureeCP}}</p> 
  </div>
...
<h5 class="navbar navbar-dark py-0 bg-gradient-danger navbar-expand-lg py-md-0 w-100 p-2 text-light">
  ...
  <div class="col-xs-4 w-50 d-inline-block p-1">
    <p>Nombre de pannes R.BT : 
    {{$rapport->nbPannesBT}}</p> 
  </div>
  <div class="col-xs-2 w-50 d-inline-block p-1">
    <p>Nombre des incidents R.BT : 
    {{$rapport->nbInciBT}}</p> 
  </div>
  ...
  <div class="col-xs-3 w-50 d-inline-block p-1">
    <p>Nombre de rédamations R.MT : 
    {{$rapport->nbRedMT}}</p> 
  </div>
  <div class="col-xs-4 w-50 d-inline-block p-1">
    <p>Nombre des incidents R.MT : 
    {{$rapport->nbInciMT}}</p> 
  </div>
  ...
  <div class="col-xs-4 w-50 d-inline-block p-1">
    <p>Nombre des postes isolés (CP) : 
    {{$rapport->nbPosteiCP}}</p> 
  </div>
  <div class="col-xs-2 w-50 d-inline-block p-1">
    <p>Nombre des troncons isolés (CP) : 
    {{$rapport->nbtronciCP}}</p> 
  </div>
...
<h5 class="navbar navbar-dark py-0 bg-gradient-danger navbar-expand-lg py-md-0 w-100 p-2 text-light">
  ...
  <div class="col-xs-4 w-25 d-inline-block p-1">
    <p>La valeur de S (tranche 1) : 
    {{$rapport->S1}}</p> 
  </div>
  <div class="col-xs-2 w-25 d-inline-block p-1">
    <p>Nombre des heures (tranche 1) : 
    {{$rapport->Heure1}}</p> 
  </div>
  <div class="col-xs-3 w-50 d-inline-block p-1">
    <p>Energie Totale en KWH (tranche 1) : 
    {{$rapport->TotalEkwh1}}</p> 
  </div>
  <div class="col-xs-4 w-50 d-inline-block p-1">
    <p>ImaxDep (tranche 1) : 
    {{$rapport->ImaxDep1}}</p> 
...
<h5 class="navbar navbar-dark py-0 bg-gradient-danger navbar-expand-lg py-md-0 w-100 p-2 text-light">
  ...
  <div class="col-xs-4 w-25 d-inline-block p-1">
    <p>La valeur de S (tranche 2) : 
    {{$rapport->S2}}</p> 
  </div>
  <div class="col-xs-2 w-25 d-inline-block p-1">
    <p>Nombre des heures (tranche 2) : 
    {{$rapport->Heure2}}</p> 
  </div>
  <div class="col-xs-3 w-50 d-inline-block p-1">
    <p>Energie Totale en KWH (tranche 2) : 
    {{$rapport->TotalEkwh2}}</p> 
  </div>
  <div class="col-xs-4 w-50 d-inline-block p-1">
    <p>ImaxDep (tranche 2) : 
    {{$rapport->ImaxDep2}}</p> 
...
<h5 class="navbar navbar-dark py-0 bg-gradient-danger navbar-expand-lg py-md-0 w-100 p-2 text-light">
  ...
  <div class="col-xs-4 w-25 d-inline-block p-1">
    <p>La valeur de S (tranche 3) : 
    {{$rapport->S3}}</p> 
  </div>
  <div class="col-xs-2 w-25 d-inline-block p-1">
    <p>Nombre des heures (tranche 3) : 
    {{$rapport->Heure3}}</p> 
  </div>
  <div class="col-xs-3 w-50 d-inline-block p-1">
    <p>Energie Totale en KWH (tranche 3) : 
    {{$rapport->TotalEkwh3}}</p> 
  </div>
  <div class="col-xs-4 w-50 d-inline-block p-1">
    <p>ImaxDep (tranche 3) : 
    {{$rapport->ImaxDep3}}</p> 
