    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3"><sup>easy</sup>Reporting</div>
            </a>
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="{{route('rapportsArchive.index')}}">
                    <i class="fas fa-envelope fa-fw"></i>
                    <span>Archive des rapports</span></a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{route('incidentsArchive.index')}}">
                    <i class="fas fa-envelope fa-fw"></i>
                    <span>Archive des incidents</span></a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{route('accidents.index')}}">
                    ...
                    <span>Accidents</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="{{route('accidentsArchive.index')}}">
                    <i class="fas fa-envelope fa-fw"></i>
                    <span>Archive des accidents</span></a>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Topbar -->
                <nav class="d-flex navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="d-flex input-group justify-content-between">
                        ...
                        <div class="d-flex form-outline">
                          <input type="search"  class="form-control mr-2" placeholder="Chercher..." />
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h3 class="h3 mb-4 text-gray-800">R.A.D.E.E.S | Easy Reporting | {{Route::currentRouteName()}}</h3>
