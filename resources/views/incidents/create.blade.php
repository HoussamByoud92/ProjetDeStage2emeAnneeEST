...
<div class="card-header py-3 bg-gradient-success">
  <h6 class="m-0 font-weight-bold text-light">Ajouter un nouveau incident en remplissant le formulaire suivant</h6>
</div>
<div class="d-flex justify-content-center m-2">
<form action="{{route('incidents.store')}}" method="post" class="container form-group row">
    @csrf
  ...
  <div class="col-xs-3 w-50 d-inline-block p-1">
    ...
    <input class="form-control border-primary border-2" id="ex3" name="Redigeant" type="text" placeholder="Saisir le rédigeant de l`incident">
  </div>
  ...
  <div class="col-xs-4 w-50 d-inline-block p-1">
    ...
    <input class="form-control border-primary border-2" id="ex3" name="signalant" type="string" placeholder="Saisir le signalant de l`incident">
  </div>
    <div class="col-xs-4 w-50 d-inline-block p-1">
...
<nav class="navbar navbar-dark py-0 bg-gradient-danger navbar-expand-lg py-md-0 w-100">
  ...
  <div class="col-xs-3 w-100 d-inline-block p-1">
    ...
    <textarea class="form-control border-primary border-2" id="ex3" name="DescInci" type="text" placeholder="Description du l’incident"></textarea>
  </div>
  <div class="col-xs-4 w-100 d-inline-block p-1">
